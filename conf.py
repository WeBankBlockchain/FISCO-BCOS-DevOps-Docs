...
project = u'FISCO-BCOS-DevOps-Docs'
...
html_context = {
    ...
    "github_repo": "FISCO-BCOS-DevOps-Docs", # Repo name
...
htmlhelp_basename = 'fisco_bcos_devops_docs'
...
man_pages = [
    (master_doc, 'FISCO-BCOS-DevOps-Docs', u'FISCO-BCOS-DevOps-Docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'FISCO-BCOS-DevOps-Docs', u'FISCO-BCOS-DevOps-Docs Documentation',
   author, 'WeBankFinTech', 'documents of FISCO-BCOS-DevOps-Docs',
   'Miscellaneous'),
]
